...
def func_th_1_thread(list,string):
    ...
    while beginn == True:
        ...
        if lesen_RamSec1.start[0] == 1 and lesen_RamSec1.worksheet[0] == 1:
            main.semaphor_sRam_Sema.release()    ##Inkrementiert +1
            #Daten aus der CSV auslesen
            try:
                with open('AnalyseDaten\RLZ_1.csv') as csvdatei:
                    print("CSV-Datei auslesen!" + '-' * 60)
                    csv_reader_object = csv.reader(csvdatei, delimiter=';')
                    row_csv = 0
                    column_csv = 0
                    data_Zwischerspeicher1.funcClear()
                    for row in csv_reader_object:
                        #print(len(row))
                        #print(row)   ##Inhalt CSV --##Zu Ansicht einkommentieren
                        if len(row) > 1 and row[1] != "":
                            data_Zwischerspeicher1.funcSpeicher0(row[1])  #Zeile Inhalt 2.Spalte
                            row_csv += 1
                    #beginn == False
                    #break
                    print(" ")
                    print(len(data_Zwischerspeicher1.data_csv_i0))
                    print(row_csv)
                    print(" ")
        ...
        if lesen_RamSec1.start[0] == 1 and lesen_RamSec1.worksheet[0] == 1:
            ...
            try:
                ...
                spalte_xlmx = 3
                zeile_csv = 0
                for i in range(len(data_Zwischerspeicher1.data_csv_i0)):
                    if data_Zwischerspeicher1.data_csv_i0[i] == "A" :
                        pass
                        #print("A " + '-' * 60)
                    if data_Zwischerspeicher1.data_csv_i0[i] == "B":
                        spalte_xlmx += 1
                        zeile_xlmx = 7
                        zeile_csv = 0
                        #print("B " + '-' * 60)
                    if data_Zwischerspeicher1.data_csv_i0[i] == "C":
                        spalte_xlmx += 1
                        zeile_xlmx = 7
                        zeile_csv = 0
                        #print("C " + '-' * 60)
                    if data_Zwischerspeicher1.data_csv_i0[i] == "D":
                        spalte_xlmx += 1
                        zeile_xlmx = 7
                        zeile_csv = 0
                        #print("D " + '-' * 60)
                    if data_Zwischerspeicher1.data_csv_i0[i] == "E":
                        spalte_xlmx += 1
                        zeile_xlmx = 7
                        zeile_csv = 0
                        #print("E " + '-' * 60)
                    if data_Zwischerspeicher1.data_csv_i0[i] == "F":
                        spalte_xlmx += 1
                        zeile_xlmx = 7
                        zeile_csv = 0
                        #print("F " + '-' * 60)
                    if data_Zwischerspeicher1.data_csv_i0[i] == "G":
                        spalte_xlmx += 1
                        zeile_xlmx = 7
                        zeile_csv = 0
                        #print("G " + '-' * 60)
                    if data_Zwischerspeicher1.data_csv_i0[i] == "H":
                        spalte_xlmx += 1
                        zeile_xlmx = 7
                        zeile_csv = 0
                        #print("H " + '-' * 60)
                    if data_Zwischerspeicher1.data_csv_i0[i] == "I":
                        spalte_xlmx += 1
                        zeile_xlmx = 7
                        zeile_csv = 0
                        #print("I " + '-' * 60)
                    if data_Zwischerspeicher1.data_csv_i0[i] == "J":
                        spalte_xlmx += 1
                        zeile_xlmx = 7
                        zeile_csv = 0
                        #print("J " + '-' * 60)
                    if data_Zwischerspeicher1.data_csv_i0[i] == "K":
                        spalte_xlmx += 1
                        zeile_xlmx = 7
                        zeile_csv = 0
                        #print("K " + '-' * 60)
                    ...
                    if zeile_csv > 0:
                        #print(type(data_Zwischerspeicher1.data_csv_i0[i]))
                        data_Zwischerspeicher1.data_csv_i0[i]=float(data_Zwischerspeicher1.data_csv_i0[i])#.replace(".", ",")
                        #print(type(data_Zwischerspeicher1.data_csv_i0[i]))
                        sheet.cell(row=zeile_xlmx, column=spalte_xlmx).value = data_Zwischerspeicher1.data_csv_i0[i]
                        zeile_xlmx += 1
                        if zeile_xlmx == 14:
                            zeile_xlmx = 16
                        if zeile_xlmx == 29:
            ...
            try:
                ...
                schreiben_RamSec1.funcClearWorksheet()
                schreiben_RamSec1.funcSec(0,1,1)
                schreiben_RamSec1.funcWS(0)
                main.semaphor_sRam_Sema.release()    ##Inkrementiert +1
